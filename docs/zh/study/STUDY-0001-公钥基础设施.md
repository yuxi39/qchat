 ...
 **链接 :**  *<https://github.com/yuxi39/qchat/docs/zh/study/STUDY-0001-公钥基础设施.md>*  
 **许可 :**  **[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/ "LICENSE Permission")**  
 **状态 :**  **学习中**
 **创建 :**  *2026-08-23*  
 **版本 :**  **version 1.0**  
 **修改 :**  **初始版本**  
 **引用 :**  `羽兮 《公钥基础设施》 v1.0 qchat:STUDY-0001 from:github.com license:"CC BY-SA 4.0"`  
```textplain
@cite 羽兮 《公钥基础设施》
version: 1.0
source: github.com
